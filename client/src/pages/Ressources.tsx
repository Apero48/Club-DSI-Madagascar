      ...
      <main className="flex-1 pt-32">
        <div className="bg-gradient-to-r from-[var(--header-footer)] to-[var(--primary)] text-white py-12">
          <div className="max-w-7xl mx-auto px-4">
            ...
            <p className="text-lg mt-2 text-white/90">Accédez à nos documents, guides et outils exclusifs</p>
          </div>
        </div>

        {/* Livres Blancs */}
        <section className="max-w-7xl mx-auto px-4 py-12">
          <h2 className="text-3xl font-bold text-[var(--header-footer)] mb-8">📚 Livres Blancs & Guides Pratiques</h2>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {[
              ...
              <Card key={index} className="p-6 hover:shadow-lg transition border border-[var(--border)]">
                <div className="flex items-start gap-3 mb-4">
                  <div className="p-2 bg-[var(--accent)]/20 rounded-lg">
                    <BookOpen className="w-5 h-5 text-[var(--primary)]" />
                  </div>
                  <h3 className="font-bold text-lg text-[var(--header-footer)]">{item.titre}</h3>
                </div>
                <p className="text-[var(--foreground)] mb-6">{item.desc}</p>
        ...
        {/* Modèles & Templates */}
        <section className="bg-[var(--accent)]/10 py-12">
          <div className="max-w-7xl mx-auto px-4">
            <h2 className="text-3xl font-bold text-[var(--header-footer)] mb-8">📋 Modèles & Templates</h2>
            <p className="text-[var(--foreground)] mb-6">Téléchargement de modèles prêts à l'emploi :</p>
          ...
          <div className="space-y-4">
            {[
              ...
              <div key={index} className="flex items-center gap-4">
                <Card className="p-4 hover:shadow-md transition cursor-pointer border border-[var(--border)] hover:border-[var(--primary)]/50">
                  <div className="flex items-center gap-3">
                    <div className="p-1.5 bg-[var(--accent)]/20 rounded">
                      <FileText className="w-4 h-4 text-[var(--primary)]" />
                    </div>
                    <span className="font-medium text-[var(--header-footer)]">{item}</span>
                  </div>
                </Card>
                <Button variant="outline" size="sm">
                  <Download className="w-4 h-4 mr-2" />
