      ...
      <main className="flex-1">
        <div className="bg-blue-700 text-white py-12">
          <div className="max-w-7xl mx-auto px-4">
            <h1 className="text-4xl font-bold">Groupes de travail thématiques</h1>
            <p className="text-lg mt-2">Missions, objectifs et membres</p>
          </div>
        </div>
        <section className="max-w-7xl mx-auto px-4 py-12 grid md:grid-cols-2 gap-6">
          {groupes.map((g,i)=> (
            <Card key={i} className="p-6 hover:shadow-md transition">
              ...
              <p className="text-gray-600 text-sm mt-2">Description à venir…</p>
            </Card>
          ))}
        </section>
      </main>
